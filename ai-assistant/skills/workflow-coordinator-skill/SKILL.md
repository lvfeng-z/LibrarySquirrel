...
> **注意**：需求分析阶段生成的**开发计划文档**（存放在 `ai-assistant/plan/`）是内部资料，用于指导开发，不需要同步到代码库。代码工程师根据计划文档开发完成后，需要通知文档维护工程师更新**代码库中的文档**（如 README、API 文档等）。
...
- [需求分析阶段生成的内部计划文档，存放在 ai-assistant/plan/]
